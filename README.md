...
**完全修复了ESPHome 2025.10.0版本中的MAC地址配置问题**
...
注意：版本1.0.20修复了MAC地址配置问题，版本1.0.19修复了polling_component_schema参数类型错误问题。
...
## 依赖项
- ESPHome ^2023.12.0 或更高版本（已在ESPHome 2025.10.0版本中测试通过，版本1.0.20完全兼容）
- ESP32设备
- JH BMS电池管理系统
